...
\par In this paper, inspired by the idea in \cite{li2025overcoming}, we present a novel iterative solver for the nonlinear system at each time step arising from the application of the convex splitting scheme to the Allen-Cahn equation with Flory-Huggins potential. 
...
More importantly, we prove the unconditional linear convergence of the iterative solver. 
