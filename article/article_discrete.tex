\section{Discrete Function Spaces and Discrete Operators}
\label{section:discrete}
In this section, we introduce the discrete function spaces and discrete operators within the framework of CCFD method \cite{tryggvason2011direct}. 
