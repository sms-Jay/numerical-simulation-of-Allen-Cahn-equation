...
double ini_1(double x, double y){
    return (1.0 + 0.5*sin(x)*sin(y))/2.0;
}
...
public:
    ...
    void solve(){
        ...
        // 打开专门用于绘图的数据文件
        ofstream energy_file("H:/undergraduate/scientific_research/allen_cahn_equation_simulation/results/data/energy_data.txt");
        ofstream residual_file("H:/undergraduate/scientific_research/allen_cahn_equation_simulation/results/data/residual_data.txt");
        ofstream bounds_file("H:/undergraduate/scientific_research/allen_cahn_equation_simulation/results/data/bounds_data.txt");
        ofstream admm_iter_file("H:/undergraduate/scientific_research/allen_cahn_equation_simulation/results/data/admm_iterations.txt");
